...
- Play style goal: allow small groups of friends to clear everything, not solo but not alliances required.
- Custom Adventuring Buddy NPC can be unlocked, 1 per player, until party is full.<br>This is a mixture of the Fellowship and Trust systems, with more control and better stats.
...
- Bot does not purchase form players, only supplies items players are not providing.
- Bot items can be changed via our feedback repository as the item list is public.

#### Demiruge is a build-it-as-we-go server, meaning that more expansions will get enabled as sufficient content exists for them. 

| **Expansions:**                                                  | **Other content:**                                                          |
| -------------                                                    | -------------                                                               |
| Original + Zilart: ☑️                                            | Zeni NMs: ☑️                                                               |
| Chains of Promathia: ☑️                                          | Magian Trials: not yet                                                      |
| Treasures of Aht Urgan: ☑️                                       | Voidwalker: _disabled until issues resolved_                                |
